    ...
    <form id="form1" runat="server">
        <div class="container-fluid">
            ...
            <nav class="navbar navbar-toggleable bg-warning">
             ...
             <br />
             <br />
            <asp:Label runat="server" Text="Bienvenid@:" CssClass="etiqueta"></asp:Label>
            ...
            <div class="container" id="Registro">
              ...
              <div class="row">
                  <div class="col-sm-6 col-md offset-4"> 
                    ...
                    <asp:TextBox runat="server" class="form-control mr-sm-2"  ID="isbn"></asp:TextBox>
                    <asp:Button Text="Buscar" runat="server" clasS="btn btn-warning" CssClass="btn btn-success" ID="btn_buscar" OnClick="btn_buscar_Click" />
                    <br />
                    <br />
                    <asp:Label runat="server" CssClass="etiqueta">Titulo:</asp:Label>
                    <asp:TextBox runat="server" class="form-control mr-sm-2"  ID="titulo"></asp:TextBox>
                    ...
                    <br />
                    <br />
                    <asp:FileUpload runat="server" id="ImagenSubir" class="etiqueta"/>
                    <br />
                    <br />
