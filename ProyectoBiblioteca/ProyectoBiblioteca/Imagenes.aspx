<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Imagenes.aspx.cs" Inherits="Imagenes" %>
        ...
        <div>
         <h1 class="text-center">Biblioteca Digital</h1>
            ...
            <ul>
                <li>
                    <div class="img-fluid">
                        <img src="App_Themes/Tema1/img/user5.jpg" id="tamañoImagen"  class="img-ts rounded-circle float-xl-left" alt="Float, izquierda" />
                    </div>
             ...
             <ul>
                <li>
                    <div class="img-fluid">
                        <img src="App_Themes/Tema1/img/user6.jpg" id="tamañoImagen"  class="img-ts rounded-circle float-xl-left" alt="Float, izquierda" />
                    </div>
                    <div>
                        <h4 id="tamañoImagen">Fundamentos</h4>
                    </div>
                </li>
            </ul>
